...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_midi_2eproto_metadata_getter(int index);
namespace midi {
class Bar;
...
inline bool PolyphonyLevel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, PolyphonyLevel* value) {
...
inline bool NoteDurationLevel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, NoteDurationLevel* value) {
...
inline bool DensityLevel_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DensityLevel* value) {
...
class Event PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_midi_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class Piece PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~Piece();
  explicit constexpr Piece(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class StatusTrack PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~StatusTrack();
  explicit constexpr StatusTrack(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void StatusTrack::_internal_set_internal_genre(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  internal_genre_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void StatusTrack::set_internal_genre(const char* value) {
  ...
  _has_bits_[0] |= 0x00000001u;
  internal_genre_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:midi.StatusTrack.internal_genre)
}
inline void StatusTrack::set_internal_genre(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  internal_genre_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* StatusTrack::_internal_mutable_internal_genre() {
  _has_bits_[0] |= 0x00000001u;
  return internal_genre_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
...
inline void SampleParam::_internal_set_ckpt(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  ckpt_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void SampleParam::set_ckpt(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  ckpt_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:midi.SampleParam.ckpt)
}
inline void SampleParam::set_ckpt(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ckpt_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:midi.SampleParam.ckpt)
}
inline std::string* SampleParam::_internal_mutable_ckpt() {
  _has_bits_[0] |= 0x00000001u;
  return ckpt_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
