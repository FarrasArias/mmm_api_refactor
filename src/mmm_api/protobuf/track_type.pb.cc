...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_track_5ftype_2eproto = {
  false, false, 414, descriptor_table_protodef_track_5ftype_2eproto, "track_type.proto", 
  &descriptor_table_track_5ftype_2eproto_once, nullptr, 0, 0,
  schemas, file_default_instances, TableStruct_track_5ftype_2eproto::offsets,
  file_level_metadata_track_5ftype_2eproto, file_level_enum_descriptors_track_5ftype_2eproto, file_level_service_descriptors_track_5ftype_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_track_5ftype_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_track_5ftype_2eproto);
  return descriptor_table_track_5ftype_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_track_5ftype_2eproto(&descriptor_table_track_5ftype_2eproto);
namespace midi {
