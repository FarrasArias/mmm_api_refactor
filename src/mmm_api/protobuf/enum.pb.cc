...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_enum_2eproto = {
  false, false, 4361, descriptor_table_protodef_enum_2eproto, "enum.proto", 
...
descriptor_table_enum_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_enum_2eproto);
  return descriptor_table_enum_2eproto.file_level_metadata[index];
}
